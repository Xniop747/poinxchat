...
giris = "\u001b[36mPoinxChat-Server Başlatılıyor...\u001b[31;1m"
...
class Group:
	...
	def sendMessage(self,message,username):
		for member in self.onlineMembers:
			if member != username:
				self.clients[member].send(bytes("\u001b[31;1m" + username + ":\u001b[37m " + message,"utf-8"))
...
def pyconChat(client, username, groupname):
	while True:
		...
		if msg == "/viewRequests":
			...
			client.send(b"/ayarlar")
			client.recv(1024).decode("utf-8")
			

		elif msg == "/colorr":
			client.send(b"/colorr")
			client.recv(1024).decode("utf-8")
...
def main():
	ip = input("İp Gir Yok İse Boş Bırakarak Enter'a Bas: ")
	...
	print(giris)
	print("\nDDDDDD  DDDDDD  DD DDD  DD DD   DD  DDDDD DD  DD DDDDDD  DDDDDD")
	print("DD  DD DD    DD DD DDDD DD  DD DD  DDD    DD  DD DD  DD    DD")
	print("DDDDDD DD    DD DD DD DDDD   DD    DD     DDDDDD DDDDDD    DD")
	print("DD     DD    DD DD DD  DDD  DD DD  DDD    DD  DD DD  DD    DD")
	print("DD      DDDDDD  DD DD   DD DD   DD  DDDDD DD  DD DD  DD    DD\n")
	print("\u001b[37m")
	print("PoinxChat Serveri Aktif")
